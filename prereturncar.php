...
<?php $login_customer = $_SESSION['login_customer']; 
    ...
    $sql1 = "SELECT `car_model`, `car_nameplate` , `start-date`, `end-date`, `no. of days`, `total_payment`,`price`
    FROM cars c 
...
<tr>
<th width="20%">Madel</th>
<th width="20%">Nameplate</th>
...
<td><?php echo $row["no. of days"]; ?></td>
<td><?php echo $row["total_payment"]; ?></td>
<td>EGP. <?php  echo ($row["price"] . "/day");
   
 

?></td>
<td><a href="returncar.php?car_nameplate=<?php echo $row["car_nameplate"];?>"> Return </a></td>
</tr>
<?php        } ?>
                </table>
                </div> 
