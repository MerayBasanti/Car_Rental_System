...
$car_availability = "active";

//$query = "INSERT into cars(car_model$car_model,car_model$car_nameplate,ac_price,non_ac_price,car_availability) VALUES('" . $car_model . "','" . $car_nameplate . "','" . $ac_price . "','" . $non_ac_price . "','" . $car_availability ."')";
...
if (!empty($_FILES["uploadedimage"]["name"])) {
    ...
    if(move_uploaded_file($temp_name, $target_path)) {
      ...
      //  $query0 = "UPDATE cars SET car_img = '$target_path' WHERE ";
        ...
        $query = "INSERT into cars(car_model, car_nameplate, car_img, car_year, price, car_availability) 
        VALUES('" . $car_model . "','" . $car_nameplate . "','".$target_path."','" . $car_year . "','" . $price. "','" . $car_availability ."')";
        $success = $conn->query($query);
