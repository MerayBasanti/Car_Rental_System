...
<div class="container">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="name">
                ...
                <?php
                $sqlcustomer="SELECT customer_username
                FROM customers";
    ...
    if (isset($_POST['name'])) {
        ...
        $sql = "SELECT  reservation.res_id, customers.customer_name, customers.customer_phone, cars.car_model,
        cars.car_nameplate,`no. of days`, reservation.total_payment, offices.office_id, offices.location
        FROM `reservation` 
        NATURAL JOIN `cars`
        NATURAL JOIN `customers`
        NATURAL JOIN `offices`
        WHERE customers.customer_username='$name'";

        $result = $conn->query($sql);

        if (mysqli_num_rows($result) > 0) {
            // Display Customer reservations within the specified period
            echo '<div class="container">
                    <div class="jumbotron">
                        <h1 class="text-center">Customer Reservations</h1>
                    </div>
                </div>';
            ...
            echo '<div class="table-responsive" style="padding-left: 100px; padding-right: 100px;" >
                    <table class="table table-striped">
                        <thead class="thead-dark">
                            <tr>
                                <th width="5%">res_id</th>
                                <th width="15%">Name</th>
                                <th width="15%">Phone</th>
                                <th width="15%">Model</th>
                                <th width="15%">car_nameplate</th>
        ...
        echo '<div class="container">
                <div class="jumbotron">
                    <h1>Please select customer username</h1>
                </div>
            </div>';
    }
    ?>
